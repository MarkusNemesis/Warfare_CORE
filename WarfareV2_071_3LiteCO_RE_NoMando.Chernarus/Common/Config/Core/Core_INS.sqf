...
_i = _i + [['','',525,21,-2,2,1,0,'Insurgents',[]]];
...
_c = _c + ['GRAD_INS'];
_i = _i + [['','',4000,35,-2,3,1,0,'Insurgents',[]]];

/* Heavy Vehicles */
_c = _c + ['BMP2_Ambul_INS'];
_i = _i + [['','',950,20,-2,0,2,0,'Insurgents',[]]];

_c = _c + ['BMP2_INS'];
_i = _i + [['','',2500,30,-2,1,2,0,'Insurgents',[]]];

_c = _c + ['ZSU_INS'];
_i = _i + [['','',3200,25,-2,1,2,0,'Insurgents',[]]]; // Markus - Moved the Insurgents Shilka up to the same level as the TKA.

_c = _c + ['T72_INS'];
_i = _i + [['','',4500,35,-2,3,2,0,'Insurgents',[]]];

/* Air Vehicles */
_c = _c + ['Mi17_Ins'];
_i = _i + [['','',12000,35,-2,1,3,0,'Insurgents',[]]]; // Markus - Airlift capable to AF1

_c = _c + ['Mi17_medevac_Ins'];
_i = _i + [['','',18000,35,-2,2,3,0,'Insurgents',[]]]; // Markus - Ambo capable to AF2

_c = _c + ['Su25_Ins'];
_i = _i + [['','',90000,55,-2,3,3,0,'Insurgents',[]]];
...
_c = _c + ['D30_Ins'];
_i = _i + [['','',2300,0,1,0,'Defense',0,'Insurgents',[]]];

...
_c = _c + ['RU_Soldier_AT'];
_i = _i + [['','',310,5,-1,2,0,0.8,'Russians',[]]];

_c = _c + ['RU_Soldier_HAT'];
_i = _i + [['','',1000,6,-1,3,0,0.84,'Russians',[]]];
...
_i = _i + [['','',550,21,-2,3,1,0,'Russians',[]]];// Markus - Ammo truck LF3

_c = _c + ['KamazRefuel'];
_i = _i + [['','',500,21,-2,3,1,0,'Russians',[]]];// Markus - Refuel truck LF3
...
_i = _i + [['','',18000,35,-2,2,3,0,'Russians',[]]];// Markus - Ambo capable to AF1

_c = _c + ['Mi17_rockets_RU'];
_i = _i + [['','',60000,45,-2,1,3,0,'Russians',[]]];
...
_c = _c + ['Ka52'];
_i = _i + [['','',if (paramBalancing) then {85000} else {100000},55,-2,if (paramBalancing) then {2} else {3},3,0,'Russians',[]]];

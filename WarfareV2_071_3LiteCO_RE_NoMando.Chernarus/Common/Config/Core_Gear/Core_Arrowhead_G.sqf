...
_u = _u + ['Javelin'];
_i = _i + [['','','CfgMagazines','secondary',670,3,false,false,0,0,true]];

_u = _u + ['M136'];
_i = _i + [['','','CfgMagazines','secondary',335,0,true,false,0,0,true]];
// Markus - HEDP gear 1 HEAT gear 2
_u = _u + ['MAAWS_HEAT'];
_i = _i + [['','','CfgMagazines','secondary',480,2,false,false,0,0,true]];

_u = _u + ['MAAWS_HEDP'];
_i = _i + [['','','CfgMagazines','secondary',190,1,false,false,0,0,true]];
/// Markus
_u = _u + ['Stinger'];
...
_u = _u + ['AT13'];
_i = _i + [['','','CfgMagazines','secondary',800,3,false,false,0,0,true]];

_u = _u + ['Dragon_EP1'];
_i = _i + [['','','CfgMagazines','secondary',360,2,false,false,0,0,true]];
...
_u = _u + ['PG7V'];
_i = _i + [['','','CfgMagazines','secondary',208,0,true,false,0,0,true]];

_u = _u + ['PG7VR'];
_i = _i + [['','','CfgMagazines','secondary',510,2,false,false,0,0,true]];

_u = _u + ['PG7VL'];
_i = _i + [['','','CfgMagazines','secondary',320,2,true,false,0,0,true]];

_u = _u + ['RPG18'];
_i = _i + [['','','CfgMagazines','secondary',300,0,true,false,0,0,true]];
...
_u = _u + ['M249_EP1'];
_i = _i + [['','','CfgWeapons','',185,1,true,false,0,0,false]];
...
_u = _u + ['Mk_48_DES_EP1'];
_i = _i + [['','','CfgWeapons','',220,2,false,false,0,0,false]];

_u = _u + ['MG36_camo'];
_i = _i + [['','','CfgWeapons','',240,1,false,false,0,0,false]];
...
_u = _u + ['MP5A5'];
_i = _i + [['','','CfgWeapons','',70,0,true,false,["30Rnd_9x19_MP5","30Rnd_9x19_MP5SD", "30Rnd_9x19_UZI", "30Rnd_9x19_UZI_SD"],0,true]];

_u = _u + ['MP5SD'];
_i = _i + [['','','CfgWeapons','',90,1,true,false,["30Rnd_9x19_MP5SD", "30Rnd_9x19_UZI_SD"],0,true]];
...
_i = _i + [['','','CfgWeapons','',210,0 ,true,false,0,0,true]];

_u = _u + ['SCAR_L_STD_Mk4CQT'];
_i = _i + [['','','CfgWeapons','',215,0,true,false,0,0,true]];
...
_i = _i + [['','','CfgWeapons','',180,3,true,false,0,0,true]]; // Markus - Made Goshawk gear 3

_u = _u + ['AKS_74_kobra'];
_i = _i + [['','','CfgWeapons','',90,0,true,false,0,0,true]];

_u = _u + ['AKS_74_NSPU'];
_i = _i + [['','','CfgWeapons','',145,3,true,false,0,0,true]]; // Markus - NSPU AK-74 now Gear 3
...
_u = _u + ['FN_FAL_ANPVS4'];
_i = _i + [['','','CfgWeapons','',140,3,true,false,0,0,true]]; // Markus - Thermal FAL now gear 3
...
_u = _u + ['RPK_74'];
_i = _i + [['','','CfgWeapons','',185,0,true,false,0,0,true]]; // Markus - RPK-74 now gear 0
...
_u = _u + ['SVD'];
_i = _i + [['','','CfgWeapons','',160,2,true,false,0,0,true]]; // Markus - SVD moved to G2

_u = _u + ['SVD_des_EP1'];
_i = _i + [['','','CfgWeapons','',180,2,false,false,0,0,true]];

_u = _u + ['SVD_NSPU_EP1'];
_i = _i + [['','','CfgWeapons','',210,3,false,false,0,0,true]]; // Markus - Thermal SVD now Gear 3
...
_i = _i + [['','','CfgWeapons','Special',275,3,true,false,0,0,true]]; // Markus - Laser designator now binocular

_u = _u + ['M136'];
_i = _i + [['','','CfgWeapons','',85,0,true,false,0,0,false]];

_u = _u + ['MAAWS'];
_i = _i + [['','','CfgWeapons','',350,1,false,false,0,0,false]]; // Markus - MAAWS Gear 1
...
_u = _u + ['PipeBomb'];
_i = _i + [['','','CfgMagazines','CfgMagazines',250,2,true,false,0,0,true]];// Markus - Satchels G2, price tweak

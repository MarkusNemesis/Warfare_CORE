...
if (paramBalancing) then {
	...
	_easaLoadout set [count _easaLoadout,
	 [
	  ...
	  [[1900],['R-73 (12)'],['R73Launcher','4Rnd_R73','4Rnd_R73','4Rnd_R73']]
	 ]
	];
...
_easaLoadout set [count _easaLoadout,
 [
  ...
  //[[1750],['GBU-12 (2) | AGM-65 (2)'],['BombLauncherF35','2Rnd_GBU12'],['MaverickLauncher','2Rnd_Maverick_A10']],// Markus - Remove Non AA/GBU from F35 EASA
  //[[2250],['AGM-65 (4)'],['MaverickLauncher','2Rnd_Maverick_A10','2Rnd_Maverick_A10']], // Markus - Remove Non AA/GBU from F35 EASA

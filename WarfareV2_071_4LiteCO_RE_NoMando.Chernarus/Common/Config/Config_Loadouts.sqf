...
['WFBE_BACKPACKS',
 ...
 'BAF_GPMG_Minitripod_D_bag','BAF_GMG_ACOG_minitripod_bag','KORD_TK_Bag_EP1','KORD_high_TK_Bag_EP1','AGS_TK_Bag_EP1','Metis_TK_Bag_EP1','2b14_82mm_TK_Bag_EP1' // Markus - Removed SPG-9 bag
 ]

...
switch (true) do {
	case WF_A2_Vanilla: {
		...
		_n set [count _n, "DSHKM_Gue"];
		_n set [count _n, "SPG9_Gue"];
		_n set [count _n, "ZU23_Gue"];
	...
	case WF_A2_Arrowhead: {
		...
		_n set [count _n, "DSHKM_TK_GUE_EP1"];
		_n set [count _n, "AGS_TK_GUE_EP1"];
		_n set [count _n, "SPG9_TK_GUE_EP1"];
		_n set [count _n, "ZU23_TK_GUE_EP1"];
		_n set [count _n, "D30_TK_GUE_EP1"];
	...
	case WF_A2_CombinedOps: {
		...
		/* RESISTANCE STATIONARY DEFENSES */
		_n			= ["WarfareBMGNest_PK_TK_GUE_EP1"];
		_n set [count _n, "GUE_WarfareBMGNest_PK"];
		_n set [count _n, "DSHKM_Gue"];
		_n set [count _n, "SPG9_Gue"];
		_n set [count _n, "ZU23_Gue"];
		_n set [count _n, "DSHKM_TK_GUE_EP1"];

...
/* Heavy Vehicles */
_c set [count _c, 'ACE_Stryker_RV_SLAT_D'];
_i set [count _i, ['','',1800,25,[false,true,2,0],0,2,0,'US',[]]];

_c set [count _c, 'ACE_M1A1HA_TUSK_DESERT'];
_i set [count _i, ['','',5850,40,-2,2,2,0,'US',[]]];

_c set [count _c, 'ACE_M1A1HA_TUSK_CSAMM_DESERT'];
_i set [count _i, ['','',6450,40,-2,3,2,0,'US',[]]];

/* Air Vehicles */
_c set [count _c, 'ACE_AH6_GAU19_FLIR'];
_i set [count _i, ['','',29500,50,-2,2,3,0,'US',[]]];

_c set [count _c, 'ACE_AH6J_DAGR_FLIR'];
_i set [count _i, ['','',35500,50,-2,2,3,0,'US',[]]];

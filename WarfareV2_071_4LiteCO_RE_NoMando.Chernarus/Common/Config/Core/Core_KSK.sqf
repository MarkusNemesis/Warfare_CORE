...
/* Infantry */
_c set [count _c, 'GER_Soldier_MG_EP1'];
_i set [count _i, ['','',340,6,-1,2,0,0.95,'KSK',[]]];

_c set [count _c, 'GER_Soldier_Medic_EP1'];
_i set [count _i, ['','',325,6,-1,2,0,0.94,'KSK',[]]];

_c set [count _c, 'GER_Soldier_EP1'];
_i set [count _i, ['','',310,6,-1,2,0,0.94,'KSK',[]]];

_c set [count _c, 'GER_Soldier_Scout_EP1'];
_i set [count _i, ['','',345,6,-1,2,0,0.96,'KSK',[]]];

_c set [count _c, 'GER_Soldier_TL_EP1'];
_i set [count _i, ['','',355,6,-1,2,0,0.98,'KSK',[]]];

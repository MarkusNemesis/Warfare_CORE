...
/* Infantry */
_c set [count _c, 'MVD_Soldier_GL'];
_i set [count _i, ['','',310,7,-1,3,0,0.98,'MVD',[]]];

_c set [count _c, 'MVD_Soldier_MG'];
_i set [count _i, ['','',320,7,-1,3,0,0.98,'MVD',[]]];

_c set [count _c, 'MVD_Soldier_Marksman'];
_i set [count _i, ['','',330,7,-1,3,0,0.99,'MVD',[]]];

_c set [count _c, 'MVD_Soldier_AT'];
_i set [count _i, ['','',345,7,-1,3,0,0.99,'MVD',[]]];

_c set [count _c, 'MVD_Soldier_Sniper'];
_i set [count _i, ['','',350,7,-1,3,0,0.99,'MVD',[]]];

_c set [count _c, 'MVD_Soldier_TL'];
_i set [count _i, ['','',360,7,-1,3,0,1.0,'MVD',[]]];

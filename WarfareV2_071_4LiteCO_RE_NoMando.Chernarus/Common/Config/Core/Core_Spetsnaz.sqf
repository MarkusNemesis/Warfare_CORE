...
/* Infantry */
_c set [count _c, 'RUS_Soldier1'];
_i set [count _i, ['','',250,6,-1,2,0,0.98,'Russians Spetsnaz',[]]];

_c set [count _c, 'RUS_Soldier2'];
_i set [count _i, ['','',260,6,-1,3,0,0.98,'Russians Spetsnaz',[]]];

_c set [count _c, 'RUS_Soldier_GL'];
_i set [count _i, ['','',270,6,-1,3,0,0.99,'Russians Spetsnaz',[]]];

_c set [count _c, 'RUS_Soldier_Marksman'];
_i set [count _i, ['','',290,6,-1,3,0,0.99,'Russians Spetsnaz',[]]];

_c set [count _c, 'RUS_Soldier3'];
_i set [count _i, ['','',295,6,-1,3,0,0.98,'Russians Spetsnaz',[]]];

_c set [count _c, 'RUS_Soldier_TL'];
_i set [count _i, ['','',300,6,-1,3,0,1.0,'Russians Spetsnaz',[]]];

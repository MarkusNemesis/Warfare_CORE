...
/* Infantry */
_c set [count _c, 'TK_Special_Forces_EP1'];
_i set [count _i, ['','',280,6,-1,2,0,0.82,'Takistani Special Forces',[]]];

_c set [count _c, 'TK_Special_Forces_TL_EP1'];
_i set [count _i, ['','',300,6,-1,2,0,0.85,'Takistani Special Forces',[]]];

_c set [count _c, 'TK_Special_Forces_MG_EP1'];
_i set [count _i, ['','',305,6,-1,2,0,0.81,'Takistani Special Forces',[]]];

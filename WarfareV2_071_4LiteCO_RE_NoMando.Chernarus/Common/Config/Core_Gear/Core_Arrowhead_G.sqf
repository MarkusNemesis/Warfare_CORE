...
_u set [count _u,  '30Rnd_9x19_UZI'];
_i set [count _i, ['','','CfgMagazines','sidearm',4,0,true,true,0,0,true]];

_u set [count _u,  '30Rnd_9x19_UZI_SD'];
...
_i set [count _i, ['','','CfgWeapons','',70,0,true,false,["30Rnd_9x19_MP5","30Rnd_9x19_MP5SD", "30Rnd_9x19_UZI", "30Rnd_9x19_UZI_SD"],0,true]];

_u set [count _u,  'MP5SD'];
_i set [count _i, ['','','CfgWeapons','',90,1,true,false,["30Rnd_9x19_MP5SD", "30Rnd_9x19_UZI_SD"],0,true]];
...
_u set [count _u,  'M2HD_mini_TriPod_u set [count _u, S_Bag_EP1'];
...
_i set [count _i, ['','','CfgWeapons','',55,1,true,false,["30Rnd_9x19_UZI","30Rnd_9x19_u set [count _u, ZI_SD"],0,true]];

_u set [count _u,  'UZI_SD_EP1'];
_i set [count _i, ['','','CfgWeapons','',65,2,true,false,["30Rnd_9x19_UZI_SD"],0,true]];

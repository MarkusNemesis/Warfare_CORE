...
_u set [count _u,'6Rnd_HE_M203'];
_i set [count _i, ['','','CfgMagazines','primary',40,0,true,false,0,0,true]];

_u set [count _u,'6Rnd_FlareWhite_M203'];
_i set [count _i, ['','','CfgMagazines','primary',30,0,true,false,0,0,true]];

_u set [count _u,'6Rnd_FlareGreen_M203'];
_i set [count _i, ['','','CfgMagazines','primary',30,0,true,false,0,0,true]];

_u set [count _u,'6Rnd_FlareRed_M203'];
_i set [count _i, ['','','CfgMagazines','primary',30,0,true,false,0,0,true]];

_u set [count _u,'6Rnd_FlareYellow_M203'];
_i set [count _i, ['','','CfgMagazines','primary',30,0,true,false,0,0,true]];

_u set [count _u,'6Rnd_Smoke_M203'];
_i set [count _i, ['','','CfgMagazines','primary',35,0,true,false,0,0,true]];

_u set [count _u,'6Rnd_SmokeRed_M203'];
_i set [count _i, ['','','CfgMagazines','primary',35,0,true,false,0,0,true]];

_u set [count _u,'6Rnd_SmokeGreen_M203'];
_i set [count _i, ['','','CfgMagazines','primary',35,0,true,false,0,0,true]];

_u set [count _u,'6Rnd_SmokeYellow_M203'];
_i set [count _i, ['','','CfgMagazines','primary',35,0,true,false,0,0,true]];

_u set [count _u,'8Rnd_B_Beneli_Pellets'];
...
_u set [count _u,'20Rnd_762x51_B_SCAR'];
...
_u set [count _u,'20Rnd_762x51_SB_SCAR'];
...
*/
_u set [count _u,'100Rnd_556x45_M249'];
...
// Markus - HEDP gear 1 HEAT gear 2
_u set [count _u,'MAAWS_HEAT'];
_i set [count _i, ['','','CfgMagazines','secondary',480,2,false,false,0,0,true]];

_u set [count _u,'MAAWS_HEDP'];
_i set [count _i, ['','','CfgMagazines','secondary',190,1,false,false,0,0,true]];
/// Markus
_u set [count _u,'Stinger'];
_i set [count _i, ['','','CfgMagazines','secondary',125,2,false,false,0,0,true]];
...
_u set [count _u,'17Rnd_9x19_glock17'];
_i set [count _i, ['','','CfgMagazines','sidearm',3,0,true,true,0,0,true]];
...
_u set [count _u,'8Rnd_B_Saiga12_Pellets'];
_i set [count _i, ['','','CfgMagazines','primary',3,0,true,false,0,0,true]];

_u set [count _u,'10Rnd_762x54_SVD'];
_i set [count _i, ['','','CfgMagazines','primary',6,0,true,false,0,0,true]];

_u set [count _u,'10x_303'];
_i set [count _i, ['','','CfgMagazines','primary',2,0,true,false,0,0,true]];

_u set [count _u,'20Rnd_762x51_FNFAL'];
_i set [count _i, ['','','CfgMagazines','primary',4,0,true,false,0,0,true]];
...
_u set [count _u,'30Rnd_762x39_SA58'];
_i set [count _i, ['','','CfgMagazines','primary',6,0,true,false,0,0,true]];
...
_u set [count _u,'Dragon_EP1'];
_i set [count _i, ['','','CfgMagazines','secondary',360,2,false,false,0,0,true]];
...
_u set [count _u,'10Rnd_B_765x17_Ball'];
_i set [count _i, ['','','CfgMagazines','sidearm',3,0,true,true,0,0,true]];

_u set [count _u,'20Rnd_B_765x17_Ball'];
_i set [count _i, ['','','CfgMagazines','sidearm',4,0,true,true,0,0,true]];

_u set [count _u,'30Rnd_9x19_u set [count _u,ZI'];
_i set [count _i, ['','','CfgMagazines','sidearm',4,0,true,true,0,0,true]];

_u set [count _u,'30Rnd_9x19_u set [count _u,ZI_SD'];
_i set [count _i, ['','','CfgMagazines','sidearm',6,0,true,true,0,0,true]];

/* Primary weapons - West */
_u set [count _u,'G36A_camo'];
_i set [count _i, ['','','CfgWeapons','',225,1,false,false,0,0,true]];

_u set [count _u,'G36C_camo'];
_i set [count _i, ['','','CfgWeapons','',195,0,true,false,0,0,true]];

_u set [count _u,'G36_C_SD_camo'];
_i set [count _i, ['','','CfgWeapons','',210,2,false,false,0,0,true]];

_u set [count _u,'G36K_camo'];
...
_u set [count _u,'M24_des_EP1'];
_i set [count _i, ['','','CfgWeapons','',140,0,true,false,0,0,true]];

_u set [count _u,'M60A4_EP1'];
_i set [count _i, ['','','CfgWeapons','',170,0,true,false,0,0,false]];

_u set [count _u,'m240_scoped_EP1'];
_i set [count _i, ['','','CfgWeapons','',165,2,true,false,0,0,false]];

_u set [count _u,'M249_EP1'];
_i set [count _i, ['','','CfgWeapons','',185,1,true,false,0,0,false]];

_u set [count _u,'M249_m145_EP1'];
_i set [count _i, ['','','CfgWeapons','',210,2,true,false,0,0,false]];

_u set [count _u,'M249_TWS_EP1'];
_i set [count _i, ['','','CfgWeapons','',285,3,false,false,0,0,false]];

_u set [count _u,'M4A1'];
_i set [count _i, ['','','CfgWeapons','',95,0,true,false,0,0,true]];

_u set [count _u,'M4A3_CCO_EP1'];
_i set [count _i, ['','','CfgWeapons','',115,0,true,false,0,0,true]];

_u set [count _u,'M4A3_RCO_GL_EP1'];
_i set [count _i, ['','','CfgWeapons','',125,1,true,false,0,0,true]];

_u set [count _u,'m107'];
_i set [count _i, ['','','CfgWeapons','',310,3,false,false,0,0,true]];

_u set [count _u,'m107_TWS_EP1'];
_i set [count _i, ['','','CfgWeapons','',410,3,false,false,0,0,false]];

_u set [count _u,'Mk_48_DES_EP1'];
_i set [count _i, ['','','CfgWeapons','',220,2,false,false,0,0,false]];

_u set [count _u,'MG36_camo'];
_i set [count _i, ['','','CfgWeapons','',240,1,false,false,0,0,false]];

_u set [count _u,'M32_EP1'];
_i set [count _i, ['','','CfgWeapons','',210,2,false,false,["6Rnd_HE_M203","6Rnd_FlareWhite_M203","6Rnd_FlareGreen_M203","6Rnd_FlareRed_M203","6Rnd_FlareYellow_M203","6Rnd_Smoke_M203","6Rnd_SmokeRed_M203","6Rnd_SmokeGreen_M203","6Rnd_SmokeYellow_M203"],0,true]];

_u set [count _u,'M79_EP1'];
_i set [count _i, ['','','CfgWeapons','',80,0,true,false,[],0,true]];

_u set [count _u,'MP5A5'];
_i set [count _i, ['','','CfgWeapons','',70,0,true,false,["30Rnd_9x19_MP5","30Rnd_9x19_MP5SD", "30Rnd_9x19_u set [count _u,ZI", "30Rnd_9x19_u set [count _u,ZI_SD"],0,true]];

_u set [count _u,'MP5SD'];
_i set [count _i, ['','','CfgWeapons','',90,1,true,false,["30Rnd_9x19_MP5SD", "30Rnd_9x19_u set [count _u,ZI_SD"],0,true]];

/* Mk13 use handgun pool ammos */
_u set [count _u,'Mk13_EP1'];
_i set [count _i, ['','','CfgWeapons','',110,0,true,false,[],0,true]];

_u set [count _u,'M14_EP1'];
_i set [count _i, ['','','CfgWeapons','',190,0,true,false,0,0,true]];

_u set [count _u,'M110_TWS_EP1'];
_i set [count _i, ['','','CfgWeapons','',350,3,false,false,0,0,true]];

_u set [count _u,'M110_NVG_EP1'];
_i set [count _i, ['','','CfgWeapons','',290,2,false,false,0,0,true]];

_u set [count _u,'SCAR_L_CQC'];
_i set [count _i, ['','','CfgWeapons','',190,0,true,false,0,0,true]];

_u set [count _u,'SCAR_L_CQC_Holo'];
_i set [count _i, ['','','CfgWeapons','',210,0 ,true,false,0,0,true]];

_u set [count _u,'SCAR_L_STD_Mk4CQT'];
_i set [count _i, ['','','CfgWeapons','',215,0,true,false,0,0,true]];

_u set [count _u,'SCAR_L_STD_EGLM_RCO'];
_i set [count _i, ['','','CfgWeapons','',230,1,true,false,0,0,true]];

_u set [count _u,'SCAR_L_CQC_EGLM_Holo'];
_i set [count _i, ['','','CfgWeapons','',245,1,true,false,0,0,true]];

_u set [count _u,'SCAR_L_STD_EGLM_TWS'];
_i set [count _i, ['','','CfgWeapons','',345,3,true,false,0,0,true]];

_u set [count _u,'SCAR_L_STD_HOLO'];
_i set [count _i, ['','','CfgWeapons','',215,0,true,false,0,0,true]];

_u set [count _u,'SCAR_H_CQC_CCO'];
_i set [count _i, ['','','CfgWeapons','',225,1,true,false,0,0,true]];

_u set [count _u,'SCAR_H_CQC_CCO_SD'];
_i set [count _i, ['','','CfgWeapons','',250,2,true,false,0,0,true]];

_u set [count _u,'SCAR_H_STD_EGLM_Spect'];
_i set [count _i, ['','','CfgWeapons','',280,2,true,false,0,0,true]];

_u set [count _u,'SCAR_H_LNG_Sniper'];
_i set [count _i, ['','','CfgWeapons','',275,2,true,false,0,0,true]];

_u set [count _u,'SCAR_H_LNG_Sniper_SD'];
_i set [count _i, ['','','CfgWeapons','',295,3,true,false,0,0,true]];

_u set [count _u,'SCAR_H_STD_TWS_SD'];
_i set [count _i, ['','','CfgWeapons','',395,3,true,false,0,0,true]];
...
_u set [count _u,'AK_74_GL_kobra'];
_i set [count _i, ['','','CfgWeapons','',85,0,true,false,0,0,true]];

_u set [count _u,'AKS_74'];
_i set [count _i, ['','','CfgWeapons','',80,0,true,false,0,0,true]];

_u set [count _u,'AKS_74_GOSHAWK'];
_i set [count _i, ['','','CfgWeapons','',180,3,true,false,0,0,true]]; // Markus - Made Goshawk gear 3

_u set [count _u,'AKS_74_kobra'];
_i set [count _i, ['','','CfgWeapons','',90,0,true,false,0,0,true]];

_u set [count _u,'AKS_74_NSPU'];
_i set [count _i, ['','','CfgWeapons','',145,3,true,false,0,0,true]]; // Markus - NSPU AK-74 now Gear 3

_u set [count _u,'AKS_74_pso'];
_i set [count _i, ['','','CfgWeapons','',105,1,true,false,0,0,true]];

_u set [count _u,'AKS_74_u set [count _u,'];
_i set [count _i, ['','','CfgWeapons','',115,0,true,false,0,0,true]];

_u set [count _u,'FN_FAL'];
_i set [count _i, ['','','CfgWeapons','',110,0,true,false,0,0,true]];

_u set [count _u,'FN_FAL_ANPVS4'];
_i set [count _i, ['','','CfgWeapons','',140,3,true,false,0,0,true]]; // Markus - Thermal FAL now gear 3

_u set [count _u,'LeeEnfield'];
...
_i set [count _i, ['','','CfgWeapons','',185,0,true,false,0,0,true]]; // Markus - RPK-74 now gear 0

_u set [count _u,'Sa58P_EP1'];
_i set [count _i, ['','','CfgWeapons','',110,0,true,false,0,0,true]];

_u set [count _u,'Sa58V_EP1'];
_i set [count _i, ['','','CfgWeapons','',120,0,true,false,0,0,true]];

_u set [count _u,'Sa58V_RCO_EP1'];
_i set [count _i, ['','','CfgWeapons','',155,1,true,false,0,0,true]];

_u set [count _u,'Sa58V_CCO_EP1'];
_i set [count _i, ['','','CfgWeapons','',145,1,true,false,0,0,true]];

_u set [count _u,'SVD'];
_i set [count _i, ['','','CfgWeapons','',160,2,true,false,0,0,true]]; // Markus - SVD moved to G2

_u set [count _u,'SVD_des_EP1'];
_i set [count _i, ['','','CfgWeapons','',180,2,false,false,0,0,true]];

_u set [count _u,'SVD_NSPU_EP1'];
_i set [count _i, ['','','CfgWeapons','',210,3,false,false,0,0,true]]; // Markus - Thermal SVD now Gear 3
...
_u set [count _u,'Javelin'];
_i set [count _i, ['','','CfgWeapons','',450,3,false,false,0,0,false]];
...
_u set [count _u,'M136'];
_i set [count _i, ['','','CfgWeapons','',85,0,true,false,0,0,false]];

_u set [count _u,'MAAWS'];
_i set [count _i, ['','','CfgWeapons','',150,1,false,false,0,0,false]]; // Markus - MAAWS Gear 1

_u set [count _u,'Stinger'];
_i set [count _i, ['','','CfgWeapons','',250,2,false,false,0,0,false]];

_u set [count _u,'US_Assault_Pack_EP1'];
_i set [count _i, ['','','CfgVehicles','',80,1,true,false,0,0,false]];

_u set [count _u,'US_Patrol_Pack_EP1'];
_i set [count _i, ['','','CfgVehicles','',70,0,true,false,0,0,false]];

_u set [count _u,'US_Backpack_EP1'];
_i set [count _i, ['','','CfgVehicles','',90,2,true,false,0,0,false]];

_u set [count _u,'Tripod_Bag'];
_i set [count _i, ['','','CfgVehicles','',25,0,true,false,0,0,false]];

_u set [count _u,'M2HD_mini_TriPod_US_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',155,0,false,false,0,0,false]];

_u set [count _u,'M2StaticMG_US_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',190,0,false,false,0,0,false]];

_u set [count _u,'MK19_TriPod_US_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',450,1,false,false,0,0,false]];

_u set [count _u,'TOW_TriPod_US_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',600,2,false,false,0,0,false]];

_u set [count _u,'M252_US_Bag_EP1'];
...
_u set [count _u,'M47Launcher_EP1'];
_i set [count _i, ['','','CfgWeapons','',250,2,false,false,0,0,false]];
...
_u set [count _u,'TK_Assault_Pack_EP1'];
_i set [count _i, ['','','CfgVehicles','',80,1,true,false,0,0,false]];

_u set [count _u,'TK_RPG_Backpack_EP1'];
_i set [count _i, ['','','CfgVehicles','',70,0,true,false,0,0,false]];

_u set [count _u,'TK_ALICE_Pack_EP1'];
_i set [count _i, ['','','CfgVehicles','',90,2,true,false,0,0,false]];

_u set [count _u,'Tripod_Bag'];
_i set [count _i, ['','','CfgVehicles','',40,0,false,false,0,0,false]];

_u set [count _u,'KORD_TK_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',155,0,false,false,0,0,false]];

_u set [count _u,'KORD_high_TK_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',190,0,false,false,0,0,false]];

_u set [count _u,'SPG9_TK_INS_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',410,1,false,false,0,0,false]];

_u set [count _u,'AGS_TK_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',490,1,false,false,0,0,false]];

_u set [count _u,'Metis_TK_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',600,2,false,false,0,0,false]];

_u set [count _u,'2b14_82mm_TK_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',750,1,false,false,0,0,false]];
...
_u set [count _u,'revolver_EP1'];
_i set [count _i, ['','','CfgWeapons','',10,0,true,false,0,0,true]];

_u set [count _u,'revolver_gold_EP1'];
_i set [count _i, ['','','CfgWeapons','',10,1,true,false,0,0,true]];

_u set [count _u,'Sa61_EP1'];
_i set [count _i, ['','','CfgWeapons','',25,0,true,false,0,0,true]];

_u set [count _u,'UZI_EP1'];
_i set [count _i, ['','','CfgWeapons','',55,1,true,false,["30Rnd_9x19_u set [count _u,ZI","30Rnd_9x19_u set [count _u,ZI_SD"],0,true]];

_u set [count _u,'UZI_SD_EP1'];
_i set [count _i, ['','','CfgWeapons','',65,2,true,false,["30Rnd_9x19_u set [count _u,ZI_SD"],0,true]];
...
_u set [count _u,'Binocular_Vector'];
_i set [count _i, ['','','CfgWeapons','Special',50,1,true,false,0,0,true]];
...
for '_z' from 0 to (count _u set [count _u,)-1 do {
	_info = (_i select _z);
	_element = (_u set [count _u,select _z);
...
diag_log Format ["[WFBE (INIT)][frameno:%2 | ticktime:%3] Core_Arrowhead_G: Loadout Initialization (%1 Elements) - [Done]",count _u set [count _u,,diag_frameno,diag_tickTime];
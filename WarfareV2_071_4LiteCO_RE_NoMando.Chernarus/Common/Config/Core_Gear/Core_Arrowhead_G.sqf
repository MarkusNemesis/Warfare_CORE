...
_u '17Rnd_9x19_glock17'];
_i set [count _i, ['','','CfgMagazines','sidearm',3,0,true,true,0,0,true]];

/* Magazines - East */
_u '5Rnd_127x108_KSVK'];
_i set [count _i, ['','','CfgMagazines','primary',11,0,true,false,0,0,true]];

_u '8Rnd_B_Saiga12_Pellets'];
_i set [count _i, ['','','CfgMagazines','primary',3,0,true,false,0,0,true]];
...
_u '20Rnd_762x51_FNFAL'];
_i set [count _i, ['','','CfgMagazines','primary',4,0,true,false,0,0,true]];

_u '20Rnd_9x39_SP5_VSS'];
_i set [count _i, ['','','CfgMagazines','primary',9,0,true,false,0,0,true]];

_u '30Rnd_545x39_AK'];
_i set [count _i, ['','','CfgMagazines','primary',4,0,true,false,0,0,true]];

_u '30Rnd_545x39_AKSD'];
_i set [count _i, ['','','CfgMagazines','primary',6,0,true,false,0,0,true]];

_u '30Rnd_762x39_AK47'];
_i set [count _i, ['','','CfgMagazines','primary',3,0,true,false,0,0,true]];

_u '30Rnd_762x39_SA58'];
_i set [count _i, ['','','CfgMagazines','primary',6,0,true,false,0,0,true]];
...
_u '8Rnd_9x18_Makarov'];
_i set [count _i, ['','','CfgMagazines','sidearm',2,0,true,true,0,0,true]];

_u '8Rnd_9x18_MakarovSD'];
_i set [count _i, ['','','CfgMagazines','sidearm',3,0,true,true,0,0,true]];

_u '10Rnd_B_765x17_Ball'];
_i set [count _i, ['','','CfgMagazines','sidearm',3,0,true,true,0,0,true]];

_u '20Rnd_B_765x17_Ball'];
_i set [count _i, ['','','CfgMagazines','sidearm',4,0,true,true,0,0,true]];

_u '30Rnd_9x19_uZI'];
_i set [count _i, ['','','CfgMagazines','sidearm',4,0,true,true,0,0,true]];

_u '30Rnd_9x19_uZI_SD'];
...
_u 'TK_Assault_Pack_EP1'];
_i set [count _i, ['','','CfgVehicles','',80,1,true,false,0,0,false]];

_u 'TK_RPG_Backpack_EP1'];
_i set [count _i, ['','','CfgVehicles','',70,0,true,false,0,0,false]];

_u 'TK_ALICE_Pack_EP1'];
_i set [count _i, ['','','CfgVehicles','',90,2,true,false,0,0,false]];
...
_u 'KORD_high_TK_Bag_EP1'];
_i set [count _i, ['','','CfgVehicles','',190,0,false,false,0,0,false]];

_u 'SPG9_TK_INS_Bag_EP1'];
...
_u 'UZI_EP1'];
_i set [count _i, ['','','CfgWeapons','',55,1,true,false,["30Rnd_9x19_uZI","30Rnd_9x19_uZI_SD"],0,true]];
...
_u '1Rnd_SmokeRed_M203'];
_i set [count _i, ['','','CfgMagazines','CfgMagazines',12,0,true,true,0,0,true]];

_u '1Rnd_SmokeGreen_M203'];
_i set [count _i, ['','','CfgMagazines','CfgMagazines',12,0,true,true,0,0,true]];

_u '1Rnd_SmokeYellow_M203'];
_i set [count _i, ['','','CfgMagazines','CfgMagazines',12,0,true,true,0,0,true]];
...
_u '1Rnd_SMOKERED_GP25'];
_i set [count _i, ['','','CfgMagazines','CfgMagazines',10,0,true,true,0,0,true]];

_u '1Rnd_SMOKEGREEN_GP25'];
_i set [count _i, ['','','CfgMagazines','CfgMagazines',10,0,true,true,0,0,true]];

_u '1Rnd_SMOKEYELLOW_GP25'];
_i set [count _i, ['','','CfgMagazines','CfgMagazines',10,0,true,true,0,0,true]];

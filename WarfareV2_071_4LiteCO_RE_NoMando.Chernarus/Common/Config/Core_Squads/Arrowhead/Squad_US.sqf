...
_aiTeamTemplateName set [count _aiTeamTemplateName, "Armor - APC Platoon (Bradley)"];
...
_u		= ["CH_47F_EP1"];
_u set [count _u, "US_Soldier_TL_EP1"];
...
_aiTeamTemplateName set [count _aiTeamTemplateName, "Air - Infantry CH-47F Squadron"];
_aiTeamTemplates set [count _aiTeamTemplates, _u];

...
if (isServer) then {
	...
	if (paramBasePatrols) then {
		...
		['WFBE_WESTBASEPATROLS_3',['US_Soldier_SL_EP1','US_Soldier_EP1','US_Soldier_AR_EP1','US_Soldier_LAT_EP1','US_Soldier_LAT_EP1','US_Soldier_GL_EP1'],true] Call SetNamespace;
	};
	...
	//--- Starting Vehicles.
	['WFBE_WESTSTARTINGVEHICLES',['M1133_MEV_EP1','MTVR_DES_EP1'],true] Call SetNamespace;

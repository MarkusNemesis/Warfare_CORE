...
_u set [count _u,'RU_Soldier_Spotter'];
_u set [count _u,'RU_Soldier_Sniper'];
_u set [count _u,'RU_Soldier_SniperH'];
_u set [count _u,'RU_Soldier_Medic'];
_u set [count _u,'RU_Soldier_TL'];
_u set [count _u,'RU_Soldier_SL'];
_u set [count _u,'RU_Soldier_Crew'];
_u set [count _u,'RU_Soldier_Pilot'];
...
_u set [count _u,'TK_Soldier_B_EP1'];
if (_tiMode) then {
	_u set [count _u,'TK_Soldier_TWS_EP1'];
};
_u set [count _u,'TK_Soldier_Engineer_EP1'];
_u set [count _u,'TK_Soldier_LAT_EP1'];
_u set [count _u,'TK_Soldier_AAT_EP1'];

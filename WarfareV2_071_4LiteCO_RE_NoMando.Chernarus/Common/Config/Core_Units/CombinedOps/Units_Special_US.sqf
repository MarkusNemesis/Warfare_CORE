...
//--- Ambulances.
['WFBE_WESTAMBULANCES',['HMMWV_Ambulance','HMMWV_Ambulance_DES_EP1','UH60M_MEV_EP1','M1133_MEV_EP1'],true] Call SetNamespace;
...
if (isServer) then {
	...
	if (paramBasePatrols) then {
		['WFBE_WESTBASEPATROLS_0',['US_Soldier_TL_EP1','US_Soldier_EP1','US_Soldier_EP1','US_Soldier_AR_EP1','US_Soldier_GL_EP1','US_Soldier_MG_EP1'],true] Call SetNamespace;
		['WFBE_WESTBASEPATROLS_1',['US_Soldier_TL_EP1','US_Soldier_EP1','US_Soldier_EP1','US_Soldier_MG_EP1','US_Soldier_LAT_EP1','US_Soldier_Medic_EP1'],true] Call SetNamespace;
		['WFBE_WESTBASEPATROLS_2',['US_Soldier_TL_EP1','US_Soldier_EP1','US_Soldier_EP1','US_Soldier_AT_EP1','US_Soldier_AA_EP1','US_Soldier_Sniper_EP1'],true] Call SetNamespace;
		['WFBE_WESTBASEPATROLS_3',['US_Soldier_TL_EP1','US_Soldier_EP1','US_Soldier_AR_EP1','US_Soldier_LAT_EP1','US_Soldier_LAT_EP1','US_Soldier_GL_EP1'],true] Call SetNamespace;
	};
	
	//--- Paratroopers.
	['WFBE_WESTPARACHUTELEVEL1',['US_Soldier_TL_EP1','US_Soldier_LAT_EP1','US_Soldier_EP1','US_Soldier_EP1','US_Soldier_AR_EP1','US_Soldier_Medic_EP1'],true] Call SetNamespace;
	['WFBE_WESTPARACHUTELEVEL2',['US_Soldier_TL_EP1','US_Soldier_AT_EP1','US_Soldier_AT_EP1','US_Soldier_AT_EP1','US_Soldier_AA_EP1','US_Soldier_MG_EP1','US_Soldier_Medic_EP1','US_Soldier_Spotter_EP1','US_Soldier_Sniper_EP1'],true] Call SetNamespace;
	...
	//--- Starting Vehicles.
	['WFBE_WESTSTARTINGVEHICLES',if (WF_Camo) then {['M1133_MEV_EP1','MTVR']} else {['M1133_MEV_EP1','MTVR_DES_EP1']},true] Call SetNamespace;

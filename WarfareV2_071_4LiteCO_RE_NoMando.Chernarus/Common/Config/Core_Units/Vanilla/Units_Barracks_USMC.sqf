...
_u set [count _u,'USMC_SoldierS_SniperH'];
_u set [count _u,'USMC_SoldierM_Marksman'];
_u set [count _u,'USMC_Soldier_Medic'];
_u set [count _u,'USMC_SoldierS_Engineer'];
_u set [count _u,'USMC_SoldierS'];
_u set [count _u,'USMC_SoldierS_Spotter'];
_u set [count _u,'USMC_Soldier_TL'];
_u set [count _u,'USMC_Soldier_SL'];
_u set [count _u,'USMC_Soldier_Crew'];
_u set [count _u,'USMC_Soldier_Pilot'];
_u set [count _u,'FR_GL'];
_u set [count _u,'FR_Corpsman'];
_u set [count _u,'FR_Assault_R'];
_u set [count _u,'FR_Assault_GL'];
_u set [count _u,'FR_AR'];
_u set [count _u,'FR_TL'];

...
//--- Balanced units.
['WFBE_BALANCEDUNITS',['HMMWV_Avenger','M6_EP1','Ka52','Ka52Black', 'An2_TK_EP1', 'F35B', 'AH1Z', 'M1133_MEV_EP1', 'Mi17_medevac_RU'],true] Call SetNamespace; // Markus - Add units here that are to be balanced.
//--- Base Area Limits.
...
['WFBE_BOUNTYMODIFIER',0.35,true] Call SetNamespace;
...
['WFBE_CAMPCAPTUREBOUNTY',250,true] Call SetNamespace;
...
// Markus - Uniformalize upgrade times
['WFBE_UPGRADETIMESLEVEL1',[60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60],true] Call SetNamespace;
['WFBE_UPGRADETIMESLEVEL2',[90,90,90,90,90,0,90,90,0,0,90,0,0,90,0,0,0,90],true] Call SetNamespace;
['WFBE_UPGRADETIMESLEVEL3',[120,120,120,120,120,0,0,0,0,0,120,0,0,120,0,0,0,120],true] Call SetNamespace;
/// Markus
...
if (('WFBE_INCOMESYSTEM' Call GetNamespace) in [3,4]) then {
	...
	//--- Commander Income %.
	if (isNil "EastCommanderPercent") then {EastCommanderPercent = 5};
	if (isNil "WestCommanderPercent") then {WestCommanderPercent = 5};
};

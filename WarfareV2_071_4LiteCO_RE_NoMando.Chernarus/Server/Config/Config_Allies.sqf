...
_alliesTeamTemplates set [count _alliesTeamTemplates,_u];
_alliesTeamTemplateRequires set [count _alliesTeamTemplateRequires,_f];
_alliesTeamTypes set [count _alliesTeamTypes,0];
_alliesTeamCost set [count _alliesTeamCost,_p];
...
_u set [count _u, "CDF_Soldier_Light"];
...
_alliesTeamTemplates set [count _alliesTeamTemplates,_u];
_alliesTeamTemplateRequires set [count _alliesTeamTemplateRequires,_f];
_alliesTeamTypes set [count _alliesTeamTypes,1];
_alliesTeamCost set [count _alliesTeamCost,_p];
...
_alliesTeamTemplates set [count _alliesTeamTemplates,_u];
_alliesTeamTemplateRequires set [count _alliesTeamTemplateRequires,_f];
_alliesTeamTypes set [count _alliesTeamTypes,2];
_alliesTeamCost set [count _alliesTeamCost,_p];
...
_alliesTeamTemplates set [count _alliesTeamTemplates,_u];
_alliesTeamTemplateRequires set [count _alliesTeamTemplateRequires,_f];
_alliesTeamTypes set [count _alliesTeamTypes,3];
_alliesTeamCost set [count _alliesTeamCost,_p];
...
_u		= ["Ins_Soldier_CO"];
_u set [count _u, "Ins_Soldier_AR"];
_u set [count _u, "Ins_Soldier_Sapper"];
_u set [count _u, "Ins_Soldier_2"];
_u set [count _u, "Ins_Soldier_AA"];
_u set [count _u, "Ins_Soldier_AA"];
_u set [count _u, "Ins_Soldier_AT"];
_u set [count _u, "Ins_Soldier_Sniper"];
_u set [count _u, "Ins_Soldier_Sab"];
_f 		= [true,false,false,false];
_p 		=0;
{_get = _x Call GetNamespace;if (!isNil '_get') then {_p = _p + (_get select QUERYUNITPRICE)}} forEach _u; 

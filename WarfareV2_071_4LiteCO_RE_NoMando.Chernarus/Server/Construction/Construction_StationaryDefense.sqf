...
_defense = createVehicle [_type, _position, [], 0, "NONE"];//_type createVehicle _position;
...
if (_type == 'Base_WarfareBBarrier10xTall') then {// Markus - Remove concrete walls, make longtalls stronger
	_defense addEventHandler ['handleDamage',{400 /*getDammage (_this select 0)+(_this select 2)/160*/}];// Markus - Make longtalls stronger
};

...
switch (_localize) do {
	...
	case "AttemptedBuildingTeamkill": {_txt = Format ["%1 attempted to teamkill a structure, dealing %2 damage. Their UID has been logged. UID: %3", _this select 1, _this select 2, _this select 3]};
};

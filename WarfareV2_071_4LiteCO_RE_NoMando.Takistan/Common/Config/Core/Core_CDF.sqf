...
_c = _c + ['ZSU_CDF'];
_i = _i + [['','',3400,35,-2,1,2,0,'CDF',[]]]; // Markus - Move All Shilkas to LF1
...
/* Air Vehicles */
_c = _c + ['Mi17_CDF'];
_i = _i + [['','',12000,35,-2,1,3,0,'CDF',[]]]; // Markus - Airlift capable to AF1

_c = _c + ['Mi17_medevac_CDF'];
_i = _i + [['','',18000,35,-2,2,3,0,'CDF',[]]]; // Markus - Ambo capable to AF2

_c = _c + ['Mi24_D'];
_i = _i + [['','',55000,40,-2,2,3,0,'CDF',[]]];// Markus - price tweak HindD

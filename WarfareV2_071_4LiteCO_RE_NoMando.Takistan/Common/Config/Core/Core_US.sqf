...
_i = _i + [['','',525,22,-2,2,1,0,'US',[]]]; // Markus - Rep truck LF2

_c = _c + ['MtvrReammo_DES_EP1'];
_i = _i + [['','',550,22,-2,3,1,0,'US',[]]]; // Markus - Ammo truck LF3

_c = _c + ['MtvrRefuel_DES_EP1'];
_i = _i + [['','',500,22,-2,3,1,0,'US',[]]]; // Markus - Fuel truck LF3
...
_i = _i + [['','',1200,25,[false,true,2,0],2,1,0,'US',[]]]; // LF2

_c = _c + ['M1126_ICV_mk19_EP1'];
_i = _i + [['','',1450,25,[false,true,2,0],2,1,0,'US',[]]]; // LF2

_c = _c + ['M1129_MC_EP1'];
_i = _i + [['','',2200,25,-2,3,1,0,'US',[]]]; // Mortar LF3

_c = _c + ['M1135_ATGMV_EP1'];
_i = _i + [['','',1550,25,-2,2,1,0,'US',[]]]; // LF2

_c = _c + ['M1133_MEV_EP1'];
_i = _i + [['','',750,25,-2,2,1,0,'US',[]]]; // LF2

/* Heavy Vehicles */
_c = _c + ['M1128_MGS_EP1'];
_i = _i + [['','',2500,25,-2,1,2,0,'US',[]]]; // HF1
/// Markus

_c = _c + ['M2A2_EP1'];
_i = _i + [['','',2750,30,-2,1,2,0,'US',[]]];

_c = _c + ['M2A3_EP1'];
_i = _i + [['','',3150,32,-2,2,2,0,'US',[]]];

_c = _c + ['M1A1_US_DES_EP1'];
_i = _i + [['','',6000,40,-2,2,2,0,'US',[]]];

_c = _c + ['MLRS_DES_EP1'];
_i = _i + [['','',6000,40,-2,3,2,0,'US',[]]];

_c = _c + ['M1A2_US_TUSK_MG_EP1'];
_i = _i + [['','',6950,40,-2,3,2,0,'US',[]]];

_c = _c + ['M6_EP1'];
_i = _i + [['','',8000,35,-2,3,2,0,'US',[]]];

/* Air Vehicles */
_c = _c + ['MH6J_EP1'];
_i = _i + [['','',8500,35,-2,0,3,0,'US',[]]];// Markus - Price tweak MH6J

_c = _c + ['UH60M_EP1'];
_i = _i + [['','',12000,35,-2,1,3,0,'US',[]]]; // Markus - Airlift capable to AF1, price tweak

_c = _c + ['UH60M_MEV_EP1'];
_i = _i + [['','',18000,35,-2,2,3,0,'US',[]]]; // Markus - Ambo capable to AF2

_c = _c + ['CH_47F_EP1'];
_i = _i + [['','',14000,40,-2,1,3,0,'US',[]]];// Markus - Airlift capable to AF1, price tweak

_c = _c + ['C130J_US_EP1'];
_i = _i + [['','',26500,55,-2,1,3,0,'US',[]]];

_c = _c + ['AH6X_EP1'];
_i = _i + [['','',35000,50,-2,1,3,0,'US',[]]];

_c = _c + ['AH6J_EP1'];
_i = _i + [['','',18000,50,-2,1,3,0,'US',[]]];// Markus - Price tweak

_c = _c + ['AH64D_EP1'];
_i = _i + [['','',80000,60,-2,2,3,0,'US',[]]];

_c = _c + ['A10_US_EP1'];
_i = _i + [['','',100000,65,-2,3,3,0,'US',[]]];
...
_i = _i + [['','',150,0,0,0,'Strategic',0,'US',[]]];

_c = _c + ['Land_BarGate2'];
_i = _i + [['','',50,0,0,0,'Strategic',0,'US',[]]];

_c = _c + ['Land_Toilet'];
_i = _i + [['','',50,0,0,0,'Strategic',0,'US',[]]];

_c = _c + ['TargetFakeTank_Lockable_EP1'];
_i = _i + [['','',500,0,0,0,'Strategic',0,'US',[]]];
/// Markus

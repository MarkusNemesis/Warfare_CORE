...
_c = _c + ['HMMWV_Armored'];
_i = _i + [['','',750,20,-2,0,1,0,'USMC',[]]]; // Markus - M240 Humvee LF0
...
_i = _i + [['','',725,22,-2,1,1,0,'USMC',[]]]; // Markus - LF 1 Ambo
...
_c = _c + ['MtvrRepair'];
_i = _i + [['','',525,22,-2,2,1,0,'USMC',[]]]; // Markus - Rep truck LF2

_c = _c + ['WarfareReammoTruck_USMC'];
_i = _i + [['','',550,22,-2,3,1,0,'USMC',[]]]; // Markus - Refuel truck LF3

_c = _c + ['MtvrRefuel'];
_i = _i + [['','',500,22,-2,3,1,0,'USMC',[]]]; // Markus - Refuel truck LF3
...
_c = _c + ['LAV25'];
_i = _i + [['','',1550,27,-2,2,1,0,'USMC',[]]]; // Moved LAV to LF2
...
_c = _c + ['M1A1'];
_i = _i + [['','',6000,40,-2,if (WF_A2_Vanilla) then {1} else {2},2,0,'USMC',[]]];

_c = _c + ['MLRS'];
_i = _i + [['','',6000,40,-2,3,2,0,'USMC',[]]];
...
/* Air Vehicles */
_c = _c + ['MH60S'];
_i = _i + [['','',15000,35,-2,1,3,0,'USMC',[]]]; // Markus - Move Airlift capable to AF1

_c = _c + ['UH1Y'];
_i = _i + [['','',20000,40,-2,1,3,0,'USMC',[]]]; // Markus - Price drop.

_c = _c + ['MV22'];
_i = _i + [['','',20000,43,-2,1,3,0,'USMC',[]]]; // Markus - Reduce price because why is it so expensive?

_c = _c + ['C130J'];
_i = _i + [['','',26500,52,-2,1,3,0,'USMC',[]]];

_c = _c + ['AH1Z'];
_i = _i + [['','',84000,60,-2,2,3,0,'USMC',[]]]; // Markus - Price tweak

_c = _c + ['AH64D'];
_i = _i + [['','',80000,60,-2,2,3,0,'USMC',[]]];

_c = _c + ['F35B'];
_i = _i + [['','',80000,62,-2,2,3,0,'USMC',[]]]; // Markus - Moved to AF2, price tweak

_c = _c + ['AV8B'];
_i = _i + [['','',90000,65,-2,2,3,0,'USMC',[]]];// Markus - Moved to AF2, price tweak

_c = _c + ['AV8B2'];
_i = _i + [['','',110000,65,-2,3,3,0,'USMC',[]]];

...
_u = _u + ['NLAW'];
_i = _i + [['','','CfgMagazines','secondary',550,0,false,false,0,0,true]];
...
_i = _i + [['','','CfgWeapons','',250,0,true,false,0,0,true]]; // Markus moved to gear 0.
...
_i = _i + [['','','CfgWeapons','',250,3,false,false,0,0,false]];
/// Markus

...
/// Markus
_u = _u + ['SMAW_HEDP'];
_i = _i + [['','','CfgMagazines','secondary',190,1,false,false,0,0,true]]; // Markus - Making HEDP rounds available at gear 1
...
_u = _u + ['RPK_74'];
_i = _i + [['','','CfgWeapons','',185,0,true,false,0,0,true]]; // Markus - RPK now gear 0.

_u = _u + ['huntingrifle'];
_i = _i + [['','','CfgWeapons','',120,0,true,false,0,0,true]];

_u = _u + ['SVD'];
_i = _i + [['','','CfgWeapons','',160,2,true,false,0,0,true]]; // Markus - SVD gear 2
...
_u = _u + ['M136'];
_i = _i + [['','','CfgWeapons','',55,0,true,false,0,0,false]];

_u = _u + ['SMAW'];
_i = _i + [['','','CfgWeapons','',150,1,false,false,0,0,false]]; // Markus - Making SMAW Gear 1

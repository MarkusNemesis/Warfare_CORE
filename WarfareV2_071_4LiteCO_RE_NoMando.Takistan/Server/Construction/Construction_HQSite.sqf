...
if (!_deployed) then {
	...
	if (paramHandleFF) then {Call Compile Format ["_site addEventHandler ['handleDamage',{[_this select 0,_this select 2,_this select 3, %1, _this select 4] Call BuildingHandleDamages}]",_side]};
	...
	if (paramHandleFF) then {Call Compile Format ["_MHQ addEventHandler ['handleDamage',{[_this select 0,_this select 2,_this select 3, %1, _this select 4] Call BuildingHandleDamages}]",_side]};
